...
"""
Flink SQL Gateway lineage module
"""
...
class FlinkSqlGatewayLineageSource(LineageSource):
    """
    Flink SQL Gateway lineage source implements view lineage
    """
    ...
    def create(
        ...
        connection: FlinkSqlGatewayConnection = config.serviceConnection.root.config
